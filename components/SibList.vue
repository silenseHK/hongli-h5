<template>
	<view class="">
		...
		<view class="">
			<view class='refreshBox' :style="isTranform">
				<view class='refresh' :style="isZoom" :class="isEnd==2?'animationSmall':''">
					...
					<!-- 加载完成样式 -->
					<image class='iconRefreshed' src='../static/iconRefreshed.png' v-if="isEnd==2"></image>
				</view>
			</view>
		</view>
		...
		<view class="">
			...
			<image v-if="isUseTop && isShowToTop" class="totop" :class="{'fade-in':isShowToTop}" src="../static/totop.png"
			 @click="toTopClick" />
		</view>
	</view>
</template>
