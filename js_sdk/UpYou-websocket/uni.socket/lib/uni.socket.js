export default class Socket {
    constructor(option = {}) {
        ...
        // 被动断开最大尝试重连次数
        this.max_reconnection = option.max_reconnection || 3;
        // 发送缓存池的数据
    ...
    off(event, handler = null) {
        let handlers = typeof this.on_register[event] === "undefined" ? [] : [...this.on_register[event]];
